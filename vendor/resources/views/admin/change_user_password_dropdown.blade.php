            ...
            @if($selectedUser)
                ...
                <form action="{{ route('admin.change-user-password.update', $selectedUser->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="password" placeholder="Masukkan kata sandi baru" required autocomplete="new-password">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message ?? '' }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password_confirmation" class="form-control" id="password_confirmation" placeholder="Konfirmasi kata sandi baru" required autocomplete="new-password">
                    </div>
