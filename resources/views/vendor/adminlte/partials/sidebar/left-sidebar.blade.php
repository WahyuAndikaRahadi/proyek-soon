            ...
            <ul class="nav nav-pills nav-sidebar flex-column {{ config('adminlte.classes_sidebar_nav', '') }}"
                ...
                @if (Auth::check())
                    @if (Auth::user()->role === 'admin')
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.password.change.form') }}" class="nav-link {{ Request::is('change-password') ? 'active' : '' }}">
                    ...
                    @elseif (Auth::user()->role === 'guru')
                        ...
                        <li class="nav-header">AKUN</li>
                        <li class="nav-item">
                            <a href="{{ route('teacher.password.change.form') }}" class="nav-link {{ Request::is('change-password') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-key"></i>
                                <p>Ubah Password</p>
                            </a>
                        </li>
