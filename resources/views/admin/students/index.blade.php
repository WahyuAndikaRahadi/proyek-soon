...
@section('content_body')
    <div class="card">
        ...
        <div class="card-body">
            {{-- Form Dropdown untuk Filter Kelas --}}
        ...
        <div class="card-footer clearfix">
            {{-- Pastikan pagination links tetap mempertahankan filter kelas --}}
            {{ $students->appends(request()->query())->links('vendor.pagination.custom-pagination-simple') }}
        </div>
    </div>
@stop