        ...
        <form method="POST" action="{{ route('admin.teachers.store') }}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="photo_url" id="photo_url" class="form-control @error('photo_url') is-invalid @enderror" value="{{ old('photo_url') }}" placeholder="Contoh: https://example.com/foto_guru.jpg">
                ...
                <div class="form-group">
                    ...
                    <select name="homeroom_class_id" id="homeroom_class_id" class="form-control @error('homeroom_class_id') is-invalid @enderror">
                        ...
                        @foreach ($classes as $class)
                            <option value="{{ $class->id }}" {{ old('homeroom_class_id') == $class->id ? 'selected' : '' }}>{{ $class->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        @foreach ($classes as $class)
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="taught_class_{{ $class->id }}" name="taught_classes[]" value="{{ $class->id }}" {{ in_array($class->id, old('taught_classes', [])) ? 'checked' : '' }}>
