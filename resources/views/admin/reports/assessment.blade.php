@extends('admin.layouts.app') {{-- Sesuaikan dengan layout admin Anda, e.g., 'admin.layouts.app' --}}

@section('page_title', 'Laporan Penilaian admin')
            ...
            <form action="{{ route('admin.reports.assessment') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <a href="{{ route('admin.reports.assessment') }}" class="btn btn-secondary"><i
...
{{ $students->appends($request->except('page'))->links('vendor.pagination.custom-pagination-simple') }}
    ...
    <form id="exportAssessmentForm" action="{{ route('admin.reports.assessment.export') }}" method="GET"
        style="display:none;">
