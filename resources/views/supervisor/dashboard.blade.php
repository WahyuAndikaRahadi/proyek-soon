@extends('supervisor.layouts.app') {{-- Sesuaikan ini dengan layout khusus supervisor Anda, e.g., 'supervisor.layout.app' atau 'layouts.supervisor' --}}

@section('page_title', 'Dashboard Supervisor')

@section('content_body')
    {{-- Konten Dashboard untuk Supervisor --}}     
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-primary">
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('supervisor.reports.attendance') }}" class="btn btn-sm btn-outline-secondary">Lihat Absensi Siswa <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card card-secondary">
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('supervisor.reports.journal') }}" class="btn btn-sm btn-outline-secondary">Lihat Jurnal Guru <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-warning">
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('supervisor.reports.assessment') }}" class="btn btn-sm btn-outline-warning">Lihat Data Siswa <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card card-info">
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('supervisor.reports.attendance') }}" class="btn btn-sm btn-outline-info">Lihat Detail Absensi <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card card-success">
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('supervisor.reports.assessment') }}" class="btn btn-sm btn-outline-success">Lihat Detail Penilaian <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card card-danger">
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('supervisor.reports.journal') }}" class="btn btn-sm btn-outline-danger">Lihat Jurnal <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
    ...
    const attendanceChart = new Chart(attendanceCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: {!! json_encode($actualAttendanceColors ?? []) !!}, // Menggunakan actualAttendanceColors
                borderWidth: 2,
                borderColor: '#fff'
            }]
        },
    ...
    const genderChart = new Chart(genderCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: {!! json_encode($actualGenderColors ?? []) !!}, // Menggunakan actualGenderColors
                borderWidth: 3,
                borderColor: '#fff'
            }]
        },
