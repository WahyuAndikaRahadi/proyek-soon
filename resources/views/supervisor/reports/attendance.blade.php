...
@section('page_title', 'Laporan Absensi Supervisor')
...
@section('content_body')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('supervisor.reports.attendance') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <a href="{{ route('supervisor.reports.attendance') }}" class="btn btn-secondary"><i
                                class="fas fa-sync"></i> Reset</a>
                        <button type="submit" class="btn btn-success float-right" form="exportAttendanceForm"><i
...
{{ $attendances->appends($request->except('page'))->links('vendor.pagination.custom-pagination-simple') }}
        </div>
    </div>

    <form id="exportAttendanceForm" action="{{ route('supervisor.reports.attendance.export') }}" method="GET"
        style="display:none;">
