...
@section('page_title', 'Laporan Jurnal Supervisor')
...
@section('content_body')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('supervisor.reports.journal') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <a href="{{ route('supervisor.reports.journal') }}" class="btn btn-secondary"><i
                                class="fas fa-sync"></i> Reset</a>
                        <button type="submit" class="btn btn-success float-right" form="exportJournalForm"><i
...
{{ $journals->appends($request->except('page'))->links('vendor.pagination.custom-pagination-simple') }}
        </div>
    </div>

    <form id="exportJournalForm" action="{{ route('supervisor.reports.journal.export') }}" method="GET" style="display:none;">
