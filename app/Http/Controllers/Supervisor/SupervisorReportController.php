...
{
    /**
     * Display the main report page for supervisors.
     *
    ...
    public function index()
    {
        ...
        return view('supervisor.reports.index', compact('classes', 'subjects', 'teachers'));
    }

    /**
     * Display attendance reports for supervisors.
     *
    ...
    public function attendance(Request $request)
    {
        ...
        return view('supervisor.reports.attendance', compact('attendances', 'classes', 'subjects', 'teachers', 'request'));
    }



    /**
     * Export attendance reports to Excel for supervisors.
     *
     * @param  \Illuminate\Http\Request  $request
    ...
    /**
     * Display journal reports for supervisors.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\View\View
     */
    public function journal(Request $request)
    {
        ...
        return view('supervisor.reports.journal', compact('journals', 'classes', 'subjects', 'teachers', 'request'));
    }



    /**
     * Export journal reports to Excel for supervisors.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\StreamedResponse
     */
    ...
    /**
     * Display assessment reports for supervisors.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Illuminate\View\View
     */
    public function assessment(Request $request)
    {
        ...
        return view('supervisor.reports.assessment', compact(
            'assessmentData',
            'classes',
            'subjects',
            'students',
    ...
    /**
     * Export assessment reports to Excel for supervisors.
     *
     * @param  \Illuminate\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\StreamedResponse
     */
